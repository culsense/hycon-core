...
export interface IRest {
    ...
    outgoingSignedTx(tx: { privateKey: string, to: string, amount: string, memo: string, fee: string, nonce: number }, queueTx?: Function): Promise<{ txHash: string } | IResponseError>
